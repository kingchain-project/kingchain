...
public:
    CMainParams()
    {
        ...
        nP2pPort = 7777;
        nRpcPort = 7778;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // KINGCHAIN starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 1;
        nTargetTimespan = 5 * 60 * 60; // KINGCHAIN
        nTargetSpacing = 4 * 60;  // KINGCHAIN 4 minutes
        nMaturity = 10;
       ...
       // nEnforceNewSporkKey = 152577780; //!> Sporks signed after (GMT): Tuesday, May 1, 2018 7:00:00 AM GMT must use the new spork key
       //nRejectOldSporkKey = 1527811200; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
        ...
        genesis.nTime = 1618866852;
        genesis.nBits = 504365040;
        genesis.nNonce = 1923067;

        hashGenesisBlock = genesis.GetHash();

           assert(hashGenesisBlock == uint256("154c036ee8af6436131e1fdea88e4f89bf19877326d32796f7191758acc0bb35"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 46); // KingChain's wallet address starts with a K
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zkong to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // KINGCHAIN: 1 day
        nTargetSpacing = 1 * 60;  // KINGCHAIN: 1 minute
        nLastPoWBlock = 200;
        nMaturity = 15;
        ...
        //vSeeds.clear();
       //  vSeeds.push_back(CDNSSeedData("tnseeder-01.kingchain.io", "tnseeder-01.kingchain.io"));
      //   vSeeds.push_back(CDNSSeedData("testnode-01.kingchain.io", "testnode-01.kingchain.io"));
        // vSeeds.push_back(CDNSSeedData("testnode-02.kingchain.io", "testnode-02.kingchain.io"));
       //  vSeeds.push_back(CDNSSeedData("testnode-03.kingchain.io", "testnode-03.kingchain.io"));
       //  vSeeds.push_back(CDNSSeedData("testnode-04.kingchain.io", "testnode-04.kingchain.io"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 17); // Testnet kingchain addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 18);  // Testnet kingchain script addresses start with '8'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 65);     // Testnet private keys start with 'T'
        // Testnet kingchain BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet kingchain BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet kingchain BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // KINGCHAIN: 1 day
        nTargetSpacing = 1 * 60;        // KINGCHAIN: 1 minutes

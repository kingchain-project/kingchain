...
/**
 * KONGCOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzkongseed(const UniValue& params, bool fHelp);
extern UniValue getzkongseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzkong(const UniValue& params, bool fHelp);
extern UniValue dzkongstate(const UniValue& params, bool fHelp);

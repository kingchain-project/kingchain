...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KONGCOIN features */
        {"kingchain", "masternode", &masternode, true, true, false},
        {"kingchain", "listmasternodes", &listmasternodes, true, true, false},
        {"kingchain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kingchain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kingchain", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kingchain", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kingchain", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kingchain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kingchain", "masternodedebug", &masternodedebug, true, true, false},
        {"kingchain", "startmasternode", &startmasternode, true, true, false},
        {"kingchain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kingchain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kingchain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kingchain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kingchain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kingchain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kingchain", "mnbudget", &mnbudget, true, true, false},
        {"kingchain", "preparebudget", &preparebudget, true, true, false},
        {"kingchain", "submitbudget", &submitbudget, true, true, false},
        {"kingchain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kingchain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kingchain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kingchain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kingchain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kingchain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kingchain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kingchain", "checkbudgets", &checkbudgets, true, true, false},
        {"kingchain", "mnsync", &mnsync, true, true, false},
        {"kingchain", "spork", &spork, true, true, false},
        {"kingchain", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzkongseed", &getzkongseed, false, false, true},
        {"zerocoin", "setzkongseed", &setzkongseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzkong", &searchdzkong, false, false, true},
        {"zerocoin", "dzkongstate", &dzkongstate, false, false, true}
...
{
    return "> kingchain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7778/\n";
}

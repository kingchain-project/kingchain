...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KingChain Core kingchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kingchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kingchain transaction") + "\n" +
                               "  kingchain-tx [options] -create [commands]   " + _("Create hex-encoded kingchain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kingchain transaction

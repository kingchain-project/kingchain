...
public:
    ...
    bool WriteZKONGSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZKONGSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZKONGSeed_deprecated(uint256& seed);
    bool EraseZKONGSeed();
    bool EraseZKONGSeed_deprecated();

    bool WriteZKONGCount(const uint32_t& nCount);
    bool ReadZKONGCount(uint32_t& nCount);

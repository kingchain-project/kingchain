...
/* KingChain GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KONGCOIN"
#define QAPP_ORG_DOMAIN "kong.io"
#define QAPP_APP_NAME_DEFAULT "KONGCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "KONGCOIN-Qt-testnet"

...
/** Utility functions used by the KONGCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render KONGCOIN addresses in monospace font
...
// Parse "kingchain:" URI into recipient object, return true on successful parsing

                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzKONGPathCustom = GetArg("-zkongbackuppath", "");
    ...
    if(!strzKONGPathCustom.empty()) {
        ui->wallet_customzkongbackuppath->setText(QString::fromStdString(strzKONGPathCustom));
        ui->wallet_customzkongbackuppath_label->setVisible(true);
        ui->wallet_customzkongbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzKONGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the KingChain RPC console.") + "<br>" +

...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zkongTracker->HasMintTx(hash))) {
            //zKONG stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZKONG;
...
bool IsZKONGType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZKONG:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZKONG || type == TransactionRecord::MNReward) {

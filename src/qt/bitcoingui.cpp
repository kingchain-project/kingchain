                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KingChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kingchain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zKONG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KingChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about KingChain Core"));
    ...
    openAction->setStatusTip(tr("Open a KONGCOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KingChain Core help message to get a list with possible KONGCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KingChain Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("KingChain Core"); // default title

...
In order to support loading of multiple wallets in kingchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kingchain.cpp.
...
Changes to kingchain.cpp
----------------------
kingchain.cpp is the entry point into kingchain-qt, and as such, will require some minor modifications to provide hooks for

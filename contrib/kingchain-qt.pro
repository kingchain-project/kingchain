...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/kingchain-cli.cpp \
           src/kingchain-tx.cpp \
           src/kingchain.cpp \
           src/db.cpp \
           ...
           src/qt/kingchain.cpp \
           src/qt/kingchainstrings.cpp \
...
RESOURCES += src/qt/kingchain.qrc src/qt/kingchain_locale.qrc

TRANSLATIONS += src/qt/locale/kingchain_bg.ts \
                src/qt/locale/kingchain_de.ts \
                src/qt/locale/kingchain_en.ts \
                src/qt/locale/kingchain_es.ts \
                src/qt/locale/kingchain_fi.ts \
                src/qt/locale/kingchain_fr.ts \
                src/qt/locale/kingchain_it.ts \
                src/qt/locale/kingchain_ja.ts \
                src/qt/locale/kingchain_pl.ts \
                src/qt/locale/kingchain_pt.ts \
                src/qt/locale/kingchain_ru.ts \
                src/qt/locale/kingchain_sk.ts \
                src/qt/locale/kingchain_sv.ts \
                src/qt/locale/kingchain_vi.ts \
                src/qt/locale/kingchain_zh_CN.ts \
                src/qt/locale/kingchain_zh_TW.ts

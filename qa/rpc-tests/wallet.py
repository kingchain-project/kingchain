...
#   c) node1 mines 32 blocks, so now node 0 has 60001kong, node 1 has 4250kong, node2 has none.
#   d) node0 sends 601 kong to node2, in two transactions (301 kong, then 300 kong).
